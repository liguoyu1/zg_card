declare global {
  ...
  const cleanupExpiredData: typeof import('../../utils/database').cleanupExpiredData
  ...
  const getRedis: typeof import('../../utils/database').getRedis
  ...
  const updateLeaderboard: typeof import('../../utils/database').updateLeaderboard
...
export { prisma, getRedis, verifyToken, createToken, calculateElo, updateLeaderboard, calculateRank, getRankName, initDatabase, cleanupExpiredData, closeConnections } from '/Users/guoyuli/Documents/code_s/zg_card/warring_states_card/server/utils/database';