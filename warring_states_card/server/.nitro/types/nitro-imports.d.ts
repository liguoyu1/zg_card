declare global {
  ...
  const verifyApplePurchase: typeof import('../../utils/apple').verifyApplePurchase
  const verifyIapApple: typeof import('../../utils/database').verifyIapApple
...
declare global {
  // @ts-ignore
  export type { ApplePurchase } from '../../utils/apple'
  import('../../utils/apple')
  // @ts-ignore
...
export { verifyApplePurchase } from '/Users/guoyuli/Documents/code_s/zg_card/warring_states_card/server/utils/apple';
export { prisma, verifyToken, createToken, calculateElo, calculateRank, getRankName, guestLogin, register, login, getPlayerProfile, updatePlayerStats, getLeaderboard, getPlayerRank, joinMatchQueue, leaveMatchQueue, checkMatchStatus, createRoom, submitGameAction, pollGameActions, getBalance, addGemsFromXsolla, verifyIapApple, addGems, spendGems, addGold, spendGold, getTransactions, initDatabase, closeConnections } from '/Users/guoyuli/Documents/code_s/zg_card/warring_states_card/server/utils/database';
