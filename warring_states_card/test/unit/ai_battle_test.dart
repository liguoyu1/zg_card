...
void main() {
  const testHero = Hero(
    id: 'H_B001', name: '孙膑', className: 'bingjia', kingdom: '齐', heroPowerName: '围魏救赵', heroPowerDescription: '获得2点护甲',
  ...
  group('AIController Battle Simulation', () {
    test('Simple AI returns play order without error', () {
      ...
      final hand = <Card>[
        const Card(id: 'C1', name: '卡牌', type: CardType.minion, cost: 3, attack: 3, health: 3,
    ...
    test('AI won\'t play cards it can\'t afford', () {
      final ai = AIController(difficulty: AIDifficulty.simple);
      final hand = [
        const Card(id: 'C1', name: '高费', type: CardType.minion, cost: 10, attack: 10, health: 10,
          description: '', owner: CardOwner.neutral, rarity: Rarity.common),
      ];
    ...
    test('AI prefers playable cards over unplayable', () {
      ...
      final hand = [
        const Card(id: 'C1', name: '低费', type: CardType.minion, cost: 3, attack: 3, health: 3,
          description: '', owner: CardOwner.neutral, rarity: Rarity.common),
        const Card(id: 'C2', name: '高费', type: CardType.minion, cost: 10, attack: 10, health: 10,
          description: '', owner: CardOwner.neutral, rarity: Rarity.common),
      ];
      final player = Player(id: 'ai', hero: testHero, mana: 5, maxMana: 5, hand: hand);
      final order = ai.getOptimalPlayOrder(hand, player);
    ...
    test('Normal AI sorts by cost descending', () {
      final ai = AIController();
      final hand = [
        const Card(id: 'C1', name: '3费', type: CardType.minion, cost: 3, attack: 3, health: 3,
          description: '', owner: CardOwner.neutral, rarity: Rarity.common),
        const Card(id: 'C2', name: '5费', type: CardType.minion, cost: 5, attack: 5, health: 5,
          description: '', owner: CardOwner.neutral, rarity: Rarity.common),
      ];
      final player = Player(id: 'ai', hero: testHero, mana: 10, maxMana: 10, hand: hand);
      final order = ai.getOptimalPlayOrder(hand, player);
    ...
    test('selectAttackTarget handles empty board', () {
      final ai = AIController();
      const self = Player(id: 'p1', hero: testHero, board: [
        Card(id: 'A1', name: '攻击者', type: CardType.minion, cost: 3, attack: 3, health: 3,
          description: '', owner: CardOwner.neutral, rarity: Rarity.common),
      ]);
      const opponent = Player(id: 'p2', hero: testHero);
    ...
    test('selectAttackTarget attacks taunt first', () {
      ...
      const opponent = Player(id: 'p2', hero: testHero, board: [
    ...
    test('Abyss AI getOptimalPlayOrder works', () {
      ...
      final hand = [
        const Card(id: 'C1', name: '随从', type: CardType.minion, cost: 3, attack: 3, health: 3,
          description: '', owner: CardOwner.neutral, rarity: Rarity.common),
      ];
      final player = Player(id: 'ai', hero: testHero, mana: 5, maxMana: 5, hand: hand);
      final order = ai.getOptimalPlayOrder(hand, player);
