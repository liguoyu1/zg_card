...
void main() {
  ...
  group('Combo System Tests', () {
    test('Combo activation check', () {
      const hand = [
        Card(id: 'Z008', name: '苏秦', type: CardType.minion, cost: 0, description: '', owner: CardOwner.zonghengjia, rarity: Rarity.epic),
        Card(id: 'Z009', name: '张仪', type: CardType.minion, cost: 0, description: '', owner: CardOwner.zonghengjia, rarity: Rarity.epic),
      ];
