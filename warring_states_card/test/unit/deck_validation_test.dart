...
void main() {
  group('Deck Validation', () {
    ...
    test('Deck with 0 cards is invalid', () {
      final deck = Deck(id: 'd3', name: '空卡组', heroId: 'H_B001', cards: const [], createdAt: DateTime.now());
      expect(deck.isValid, isFalse);
    });
    ...
    test('Deck.id is unique for different instances', () {
      final d1 = Deck(id: 'a', name: 'A', heroId: 'H_B001', cards: const [], createdAt: DateTime.now());
      final d2 = Deck(id: 'b', name: 'B', heroId: 'H_B001', cards: const [], createdAt: DateTime.now());
