...
void main() {
  const testHero = Hero(
    id: 'H_TEST', name: '测试英雄', className: 'test', kingdom: '测',
    health: 30, heroPowerName: '测试', heroPowerDescription: '测试',
  ...
  group('Edge Cases', () {
    ...
    test('Max mana capped at 10', () {
      final player = Player(id: 'p1', hero: testHero, mana: 15, maxMana: 15);
