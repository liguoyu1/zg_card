...
void main() {
  ...
  group('Player模型验证', () {
    test('玩家初始状态正确', () {
      final player = Player(id: 'test', hero: testHero);
  ...
  group('AIController验证', () {
    test('简单AI随机出牌', () {
      ...
      final player = Player(id: 'ai', hero: testHero);
  ...
  group('GameRules验证', () {
    test('游戏结束判定-玩家死亡', () {
      final player1 = Player(id: 'p1', hero: testHero, health: 0);
      final player2 = Player(id: 'p2', hero: testHero, health: 30);
    ...
    test('游戏结束判定-双方存活', () {
      final player1 = Player(id: 'p1', hero: testHero, health: 30);
      final player2 = Player(id: 'p2', hero: testHero, health: 30);
