                  ...
                  child: Container(
                    ...
                    child: revealProgress > 0.5
                        ? Column(
                            ...
                            children: [
                              Text('${card.cost}', style: const TextStyle(color: _gold, fontWeight: FontWeight.bold)),
                              Text(card.name, style: const TextStyle(color: Colors.white, fontSize: 10), overflow: TextOverflow.ellipsis),
                            ],
                          )
                        : Container(
                            decoration: BoxDecoration(
