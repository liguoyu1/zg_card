...
class _BoardCardState extends State<BoardCard> with TickerProviderStateMixin {
  ...
  Widget _buildKeywordIcons() {
    ...
    if (widget.card.keywords.contains(Keyword.charge)) {
      icons.add(Image.asset('assets/icons/charge.png', width: 12, height: 12));
    }
    if (widget.card.keywords.contains(Keyword.taunt)) {
      icons.add(Image.asset('assets/icons/taunt.png', width: 12, height: 12));
    }
    if (widget.card.keywords.contains(Keyword.divineShield)) {
      icons.add(Image.asset('assets/icons/divine_shield.png', width: 12, height: 12));
    }
    if (widget.card.keywords.contains(Keyword.windfury)) {
      icons.add(Image.asset('assets/icons/windfury.png', width: 12, height: 12));
    }
    if (widget.card.keywords.contains(Keyword.lifesteal)) {
      icons.add(Image.asset('assets/icons/lifesteal.png', width: 12, height: 12));
    }
    ...
    return Row(
      ...
      children: icons.take(2).toList(), // 最多显示2个
    );
  }
}