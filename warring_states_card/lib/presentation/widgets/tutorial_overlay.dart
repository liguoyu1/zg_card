          ...
          child: GestureDetector(
            onTap: () {
              if (_step < steps.length - 1) {
                _fadeCtrl.reset(); setState(() => _step++); _fadeCtrl.forward();
              } else { widget.onComplete(); }
            },
            child: CustomPaint(
              painter: _HolePainter(holeCenter: Offset(MediaQuery.of(context).size.width * s.holeX, MediaQuery.of(context).size.height * s.holeY), holeRadius: s.holeR),
            ...
            child: Container(
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                ...
                Container(
                  ...
                  child: Text(_step < steps.length - 1 ? LocaleService.I.t('tutorial.next') : LocaleService.I.t('tutorial.start'), style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                ),
              ]),
            ),
          ),
        ...
        Positioned(bottom: 40, left: 0, right: 0,
          child: Row(mainAxisAlignment: MainAxisAlignment.center,
            children: List.generate(steps.length, (i) => Container(
              ...
              decoration: BoxDecoration(shape: BoxShape.circle, color: i == _step ? _gold : Colors.grey[600]),
            )),
          ),
        ),
      ]),
