...
const List<Card> neutralCards = [
  ...
  Card(id: 'N029', name: '调兵遣将', type: CardType.spell, cost: 1, 
       description: '抽两张牌', owner: CardOwner.neutral, rarity: Rarity.rare,
       flavor: '调兵遣将，调度有方。'),
  Card(id: 'N030', name: '四面楚歌', type: CardType.spell, cost: 2, 
       description: '对所有敌方随从造成1点伤害', owner: CardOwner.neutral, rarity: Rarity.common,
       flavor: '四面楚歌，敌军围困。'),
  Card(id: 'N031', name: '知己知彼', type: CardType.spell, cost: 2, 
       description: '发现一张卡牌', owner: CardOwner.neutral, rarity: Rarity.common,
       flavor: '知己知彼，百战不殆。'),
  Card(id: 'N032', name: '坚壁清野', type: CardType.spell, cost: 3, 
       description: '使所有随从获得+0/+2', owner: CardOwner.neutral, rarity: Rarity.rare,
       flavor: '坚壁清野，敌军无所获。'),
  Card(id: 'N033', name: '以少胜多', type: CardType.spell, cost: 4, 
       description: '对一个随从造成4点伤害', owner: CardOwner.neutral, rarity: Rarity.rare,
       flavor: '兵贵精不贵多。'),
  Card(id: 'N034', name: '奇袭', type: CardType.spell, cost: 3, 
       description: '对敌方英雄造成3点伤害', owner: CardOwner.neutral, rarity: Rarity.common,
       flavor: '奇袭得手，敌军大乱。'),
  Card(id: 'N035', name: '增援', type: CardType.spell, cost: 5, 
       description: '召唤两个2/2的士兵', owner: CardOwner.neutral, rarity: Rarity.rare,
       flavor: '增援部队，源源不断。'),
  Card(id: 'N036', name: '决胜局', type: CardType.spell, cost: 6, 
       description: '抽三张牌', owner: CardOwner.neutral, rarity: Rarity.rare,
       flavor: '决战时刻，一决胜负。'),
  Card(id: 'N037', name: '横扫千军', type: CardType.spell, cost: 7, 
       description: '对所有敌方随从造成5点伤害', owner: CardOwner.neutral, rarity: Rarity.epic,
       flavor: '横扫千军如卷席。'),
  Card(id: 'N038', name: '反戈一击', type: CardType.spell, cost: 4, 
       description: '使一个随从获得+3/+3和嘲讽', owner: CardOwner.neutral, rarity: Rarity.rare,
       flavor: '反戈一击，攻守易形。'),
  // 武器
