...
class DrawService {
  ...
  DrawResult drawWithPity({
    ...
    // 计算当前概率(基础+保底加成)
    final double currentProb = baseProbabilities[targetRarity]!;
    final double pityBonus = (currentPityCount * pityIncrement).clamp(0, pityCap - currentProb);
    final double adjustedProb = currentProb + pityBonus;
