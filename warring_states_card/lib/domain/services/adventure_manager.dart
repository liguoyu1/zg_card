...
class AdventureManager {
  ...
  static List<AdventureChapter> _buildChapters() {
    return [
      ...
      // ==================== 第4章：百家争鸣 (12关) ====================
      AdventureChapter(id: 'chapter_4', name: '百家争鸣',
        description: '深入诸子各家，领悟百家精髓', missions: [
        AdventureMission(id: '4-1', name: '道法自然', description: '再会庄子，领悟天人合一',
          difficulty: Difficulty.normal, enemyHero: 'H_D001', prerequisite: '3-final', rewardGold: 60, rewardCards: ['C_D011']),
        AdventureMission(id: '4-2', name: '法网恢恢', description: '面对申不害的术治体系',
          difficulty: Difficulty.hard, enemyHero: 'H_F003', prerequisite: '4-1', rewardGold: 80, rewardCards: ['C_F011']),
        AdventureMission(id: '4-3', name: '兼爱天下', description: '深入墨家腹地',
          difficulty: Difficulty.hard, enemyHero: 'H_M001', prerequisite: '4-2', rewardGold: 80, rewardCards: ['C_M010']),
        AdventureMission(id: '4-4', name: '齐物逍遥', description: '列子御风而行，变幻莫测',
          difficulty: Difficulty.extreme, enemyHero: 'H_D003', prerequisite: '4-3', rewardGold: 150, rewardCards: ['C_D011'], isBoss: true),
        AdventureMission(id: '4-5', name: '阴阳颠倒', description: '安期生施展阴阳秘术',
          difficulty: Difficulty.normal, enemyHero: 'H_Y003', prerequisite: '4-4', rewardGold: 60, rewardCards: ['C_Y011']),
        AdventureMission(id: '4-6', name: '仁义无敌', description: '孟子携浩然正气而来',
          difficulty: Difficulty.hard, enemyHero: 'H_R002', prerequisite: '4-5', rewardGold: 80, rewardCards: ['C_R009']),
        AdventureMission(id: '4-7', name: '坚白之辩', description: '名家辩士言辞如刀',
          difficulty: Difficulty.extreme, enemyHero: 'H_Z001', prerequisite: '4-6', rewardGold: 120, rewardCards: ['C_Z011']),
        AdventureMission(id: '4-8', name: '一鸣惊人', description: '齐威王整顿朝纲',
          difficulty: Difficulty.hard, enemyHero: 'H_B003', prerequisite: '4-7', rewardGold: 80, rewardCards: ['C_B011']),
        AdventureMission(id: '4-9', name: '胡服骑射', description: '赵武灵王改制强军',
          difficulty: Difficulty.hard, enemyHero: 'H_B002', prerequisite: '4-8', rewardGold: 80, rewardCards: ['C_B005']),
        AdventureMission(id: '4-10', name: '相秦制霸', description: '张仪凭借三寸不烂之舌',
          difficulty: Difficulty.extreme, enemyHero: 'H_Z002', prerequisite: '4-9', rewardGold: 150, rewardCards: ['C_Z009'], isBoss: true),
        AdventureMission(id: '4-11', name: '甘罗拜相', description: '少年天才甘罗舌战群儒',
          difficulty: Difficulty.normal, enemyHero: 'H_R001', prerequisite: '4-10', rewardGold: 60, rewardCards: ['C_R003']),
        AdventureMission(id: '4-12', name: '毛遂自荐', description: '毛遂凭出众胆识脱颖而出',
          difficulty: Difficulty.hard, enemyHero: 'H_Z001', prerequisite: '4-11', rewardGold: 80, rewardCards: ['C_Z005']),
      ]),
      // ==================== 第5章：千古一帝 (14关) ====================
      AdventureChapter(id: 'chapter_5', name: '千古一帝',
        description: '终结战国乱世，成就千古霸业', missions: [
        AdventureMission(id: '5-1', name: '远交近攻', description: '范雎献计远交近攻',
          difficulty: Difficulty.hard, enemyHero: 'H_Z001', prerequisite: '4-12', rewardGold: 100, rewardCards: ['C_Z010']),
        AdventureMission(id: '5-2', name: '李牧守边', description: '赵国名将李牧长城固守',
          difficulty: Difficulty.extreme, enemyHero: 'H_B003', prerequisite: '5-1', rewardGold: 120, rewardCards: ['C_B012']),
        AdventureMission(id: '5-3', name: '吕氏春秋', description: '吕不韦权倾朝野',
          difficulty: Difficulty.hard, enemyHero: 'H_F001', prerequisite: '5-2', rewardGold: 100, rewardCards: ['C_F008']),
        AdventureMission(id: '5-4', name: '嫪毐之乱', description: '平定嫪毐叛乱',
          difficulty: Difficulty.hard, enemyHero: 'H_Z002', prerequisite: '5-3', rewardGold: 100, rewardCards: ['C_F006']),
        AdventureMission(id: '5-5', name: '罢黜百家', description: '李斯献策统一思想',
          difficulty: Difficulty.extreme, enemyHero: 'H_F003', prerequisite: '5-4', rewardGold: 150, rewardCards: ['C_F010'], isBoss: true),
        AdventureMission(id: '5-6', name: '修筑长城', description: '北驱匈奴，修筑万里长城',
          difficulty: Difficulty.hard, enemyHero: 'H_B003', prerequisite: '5-5', rewardGold: 100, rewardCards: ['C_B006']),
        AdventureMission(id: '5-7', name: '灵渠贯通', description: '史禄开凿灵渠沟通水系',
          difficulty: Difficulty.normal, enemyHero: 'H_M002', prerequisite: '5-6', rewardGold: 80, rewardCards: ['C_M008']),
        AdventureMission(id: '5-8', name: '徐福东渡', description: '方士徐福出海寻仙',
          difficulty: Difficulty.hard, enemyHero: 'H_Y002', prerequisite: '5-7', rewardGold: 100, rewardCards: ['C_Y009']),
        AdventureMission(id: '5-9', name: '博浪沙刺', description: '张良在博浪沙伏击始皇',
          difficulty: Difficulty.extreme, enemyHero: 'H_Z001', prerequisite: '5-8', rewardGold: 150, rewardCards: ['C_Z004']),
        AdventureMission(id: '5-10', name: '焚书令下', description: '李斯主持焚书',
          difficulty: Difficulty.hard, enemyHero: 'H_F002', prerequisite: '5-9', rewardGold: 100, rewardCards: ['C_F007'], isBoss: true),
        AdventureMission(id: '5-11', name: '沙丘之谋', description: '赵高密谋篡改遗诏',
          difficulty: Difficulty.extreme, enemyHero: 'H_Z002', prerequisite: '5-10', rewardGold: 150, rewardCards: ['C_Z003']),
        AdventureMission(id: '5-12', name: '大泽乡起义', description: '陈胜吴广揭竿而起',
          difficulty: Difficulty.hard, enemyHero: 'H_B002', prerequisite: '5-11', rewardGold: 100, rewardCards: ['C_B002']),
        AdventureMission(id: '5-13', name: '楚汉相争', description: '项羽刘邦争夺天下',
          difficulty: Difficulty.extreme, enemyHero: 'H_B001', prerequisite: '5-12', rewardGold: 200, rewardCards: ['C_B008']),
        AdventureMission(id: '5-final', name: '千秋万代', description: '终结乱世，开启大汉王朝',
          difficulty: Difficulty.extreme, enemyHero: 'H_Z003', prerequisite: '5-13', rewardGold: 800, rewardCards: ['C_N025', 'C_N028', 'C_B008'], isBoss: true, isFinal: true),
      ]),
    ];
  }
}
